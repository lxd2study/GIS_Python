...
本系统支持 **24种** 遥感指数和合成类型，涵盖农业、城市、水利、林业和设施农业等多个应用领域。
...
## 🏠 大棚指数 (Greenhouse Index)

### APGI - Sentinel-2 大棚指数
```
公式: 100 * Coastal * Red * (2*NIR - Red - SWIR2) / (2*NIR + Red + SWIR2)
传感器: Sentinel-2 L2A
波段: B01 (Coastal), B04 (Red), B08 (NIR), B12 (SWIR2)
用途: 塑料大棚提取、设施农业空间制图
注意: APGI 输出连续指数结果，不在系统内自动二值化；阈值需结合研究区样本、季节和棚膜类型确定。
```
