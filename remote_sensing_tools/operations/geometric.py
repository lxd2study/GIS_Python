...
def clip_raster(input_path: str, output_path: str,
               ...
               shapefile: str = None,
               dst_nodata: Optional[float] = None) -> str:
    """
    裁剪栅格影像
    ...
    if source_ds is None:
        raise Exception(f"无法打开输入影像: {input_path}")

    if dst_nodata is None and source_ds.RasterCount > 0:
        dst_nodata = source_ds.GetRasterBand(1).GetNoDataValue()
