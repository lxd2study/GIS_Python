<template>
  <div class="flow-node radiometric-node" :class="{ selected: props.selected }">
    ...
    <div class="node-header">
      ...
      <span class="node-title">辐射定标</span>
      <span class="node-lock">
